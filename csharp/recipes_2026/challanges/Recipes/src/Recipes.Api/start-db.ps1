...
# Now run EF migrations using recipes_admin
Write-Host "`nApplying Entity Framework migrations..."
$adminConnectionString = "Server=localhost,14333;Database=Recipes;User Id=recipes_admin;Password=StrongP4ssword123;TrustServerCertificate=true;"

Push-Location $ProjectPath
try {
    dotnet ef database update --connection $adminConnectionString
    if ($LASTEXITCODE -eq 0) {
